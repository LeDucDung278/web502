                    ...
                    <div className="w-9/12">
                        <form action="">
                            <div className="input-group relative flex items-stretch w-full">
                                <input type="text" id="search_content" className="form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid transition ease-in-out m-0 focus:border-none focus:text-gray-700 focus:bg-white focus:border-none shadow-sm" placeholder="Tìm kiếm" aria-label="Search" aria-describedby="button-addon2" autoComplete="off" />
                                <button onClick={onSearch} className=" inline-block px-6 py-2.5 bg-orange-700 text-white font-medium text-xs leading-tight uppercase rounded-r shadow-md hover:bg-orange-600 hover:shadow-lg focus:bg-orange-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
